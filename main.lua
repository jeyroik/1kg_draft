...
function love.draw()
	...
	love.graphics.print('['..love.graphics.getWidth()..','..love.graphics.getHeight()..'] '..mouse.x..', '..mouse.y..' scale: '..VisibleObject.globalSX..','..VisibleObject.globalSY, mouse.x + 3, mouse.y-10)
